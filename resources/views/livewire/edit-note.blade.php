<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
    ...
    <main class="max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        {{-- Page Title --}}
        <div class="mb-8">
            <h2 class="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">Edit Note</h2>
            <p class="text-slate-600">Update your note's content and settings.</p>
        </div>
                ...
                <form wire:submit="update" class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-4">
                        <button
                            ...
                            wire:target="update"
                        >
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" wire:loading.remove wire:target="update">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                            </svg>
                            <svg class="animate-spin w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" wire:loading wire:target="update">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <span wire:loading.remove wire:target="update">Update Note</span>
